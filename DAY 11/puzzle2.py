...
multiplied_divisible_by = 1

# for each monkey
for monkey in monkeys:
    # multiply every divisible_by together
    multiplied_divisible_by *= monkey.divisible_by

if DEBUG:
    print(multiplied_divisible_by)
...
for _ in range(10000):
    ...
    for i, monkey in enumerate(monkeys):
        ...
        for item in monkey.items:
            ...
            # get worry level modulo the divisible by number
            worry_level = worry_level % multiplied_divisible_by
